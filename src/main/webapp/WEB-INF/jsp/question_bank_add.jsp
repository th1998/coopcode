...
<body>
                        ...
                        <div class="layui-card-body ">
                           <form class="layui-form"> 
							  ...
							  <div class="layui-form-item">
							    ...
							    <div class="layui-input-block">
							      <input type="text" id="title" name="title" placeholder="请输入" autocomplete="off" class="layui-input" lay-verify="required" >
							    </div>
							  </div>
							  ...
							  <div class="layui-form-item">
							    ...
							    <div class="layui-input-block">
							      <input type="text" id="difficulty" name="difficulty"  placeholder="请输入" autocomplete="off" class="layui-input" lay-verify="required" >
							    </div>
							  </div>
  ...
  form.on('submit(entry)', function(data){
     var url = '${pageContext.request.contextPath}/add_submit';
     var param = $(".layui-form").serialize();
     $.post(url, param, function (res) {
        if(res.flag == 1){
        	layer.msg(res.content,{icon: 1,time:1000},function(){location.reload();});
        }else{
